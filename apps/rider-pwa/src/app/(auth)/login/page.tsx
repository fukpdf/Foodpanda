    ...
    <main className="min-h-dvh flex items-center justify-center bg-gray-50 px-4 py-12">
      <div className="w-full max-w-sm">
        <div className="mb-8 text-center">
          ...
          <h1 className="text-2xl font-bold text-gray-900">Start delivering</h1>
          <p className="mt-1.5 text-sm text-gray-500">Sign in to go online and accept orders</p>
        </div>
        <div className="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
          <form className="space-y-5" action="#" method="POST">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="email" className="text-sm font-medium text-gray-700">Email address</label>
              <input id="email" name="email" type="email" autoComplete="email" required placeholder="rider@example.com"
        ...
        <p className="mt-6 text-center text-sm text-gray-500">
          Want to be a rider?{" "}
          <Link href="/auth/register" className="font-semibold text-brand-600 hover:text-brand-700">Apply here</Link>
        </p>
      </div>
    </main>
  );
